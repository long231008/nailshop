...
from app.schedule.presentation.schemas import DailyAppointment, DailyScheduleResponse
...
def daily_schedule(
    ...
    """Every confirmed appointment of one day. Admins and staff alike can look
    at any branch (or all of them at once)."""
    appointments = get_daily_schedule(db, date, branch_id)
